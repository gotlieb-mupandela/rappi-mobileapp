  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: theme.bg }} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        <Pressable
          onPress={() => push({ key: 'notifications' })}
          style={[styles.bell, { backgroundColor: theme.surface }]}
          testID="me-bell"
      ...
      <View style={[styles.card, { backgroundColor: theme.surface }]}>
        <View style={styles.cardHead}>
          ...
          <Pressable onPress={() => push({ key: 'orders' })} testID="view-all-orders">
        ...
        <View style={styles.statusRow}>
          {[
            ...
            <Pressable key={s.label} onPress={() => push({ key: 'orders' })} style={styles.status}>
...
const styles = StyleSheet.create({
  ...
  cta: { marginTop: 16, borderRadius: radius.lg, paddingVertical: 14, alignItems: 'center' },
  card: { marginTop: 20, borderRadius: radius.xl, padding: 16 },
